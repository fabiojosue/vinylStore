  ...
  return (
    <footer className="footer">
      <ul className="social-icon">
        ...
        <li className="social-icon__item">
          <a className="social-icon__link" href="https://cr.linkedin.com/in/fabio-calder%C3%B3n-torres-46374821a" target='_blank'>
        ...
        <li className="social-icon__item">
          <a className="social-icon__link" href="https://www.instagram.com/fabio_josue/" target='_blank'>
      ...
      <p>&copy; Fabio Calderón Torres | 2024</p>
